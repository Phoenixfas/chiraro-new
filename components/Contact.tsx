...
const Contact = () => {
    return (
        <section className="flex flex-col pt-48 w-full px-[200px] relative justify-center items-center text-center">
            ...
            <h1 className="text-[40px] font-[700] w-fit mb-16 text-center capitalize">
                Elevate your <br />
                digital presence with  <span className="text-[#43D0F7]">Chiraro</span>
            </h1>

            <p className='text-[22px] font-[400] leading-[200%] mb-16 px-[200px]'>Contact us today to discuss your project requirements and take the first step to wardsachieving your goals!</p>
