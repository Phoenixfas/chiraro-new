    ...
    <section className="w-full h-full items-center justify-center flex relative py-[150px]">
      <div className="w-[calc(100%-200px)] flex flex-col gap-[50px] mb-20 md:mb-0 items-center justify-center relative ">
        <h1 className="text-[68px] font-[700] w-fit ">
          Our Recent<span className="text-[#43D0F7]"> Clients</span>
        </h1>
        ...
        <div className="overflow-hidden p-5">
          ...
          >
            <Link
              ...
              className="min-w-[30%] h-[270px] bg-[#393E4680] rounded-2xl p-4 relative [&>div]:hover:translate-y-0 overflow-hidden"
            >
              <Image
                alt="Sawla Tours"
                width={800}
            ...
            <Link
              ...
              className="min-w-[30%] h-[270px] bg-[#393E4680] rounded-2xl p-4 relative [&>.name]:hover:translate-y-0 overflow-hidden"
            >
              <Image
