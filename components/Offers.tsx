...
const Offers = () => {
  return (
    <section id='offers' className='w-full items-center justify-center flex relative'>
      <div className='w-[calc(100%-200px)]  pt-[250px] pl-[80px] flex flex-col gap-[50px] mb-20 md:mb-0 items-start justify-start'>
        <div className='w-[90%] lg:w-[750px] h-fit pl-[100px] pr-[40px] py-5 rounded-xl bg-[rgba(47,64,75,1)] relative'>
          ...
          <p className='text-[18px] font-light leading-[32px] tracking-wider pb-5'>Building a foundation of trust, our commitment to security goes beyond mere protection it&apos;s about constructing robust digital fortresses that safeguard your data and assets, ensuring a resilient defense against the evolving landscape of cyber threats.</p>
        </div>
        ...
        <div className='w-[90%] lg:w-[750px] h-fit pl-[100px] pr-[40px] py-5 rounded-xl bg-[rgba(47,64,75,1)] relative'>
          ...
          <h1 className='text-[36px] font-semibold pb-1'>Secure</h1>
          <p className='text-[18px] font-light leading-[32px] tracking-wider pb-5'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Vel qui reprehenderit nemo iusto harum aliquam, animi asperiores natus, excepturi inventore impedit veritatis quae fuga. Quod, fugit? Animi eligendi doloremque nihil quis minima veniam deserunt dignissimos.</p>

        </div>

      </div><div className="absolute bottom-[150px] left-0 w-full h-[1px] bg-[rgba(238,238,238,0.1)] -z-[1]" ></div>
    </section>
  )
}
