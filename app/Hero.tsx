...
export default function Hero() {
  return (
    <div
      id="hero"
      className="w-full md:w-[calc(100%-200px)] md:h-screen pt-[150px] flex justify-center items-center flex-col-reverse md:flex-row mb-20 md:mb-0 "
    >
      ...
      <div className="w-full md:w-1/2 flex justify-center items-center md:pr-10">
        <Hero3d />
      </div>
    </div>
  );
