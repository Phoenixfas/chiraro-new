  ...
  return (
    <div className='w-full flex flex-col items-center relative overflow-x-clip mt-40 px-5 sm:px-10 md:px-28 gap-20'>
      ...
      <div className="relative flex flex-col items-center">
        <h1 className='lg:text-[64px] text-center lg:leading-[6rem] md:text-6xl md:leading-[5.25rem] text-[2.5rem] leading-[3rem] font-black font-poppins mb-10 tracking-[widest]'>Our <span className='text-[#43D0F7]'>Team</span></h1>
        <p className='text-[25px] text-center font-normal leading-[37.5px]'>Behind every successful campaign is a dedicated team of professionals.  Meet the talented individuals who make up the Chiraro team and discover the expertise and passion they bring to every project.</p>
      </div>
