  ...
  return (
    <div className='flex flex-col pt-10 lg:pt-24 w-full px-7 sm:px-[50px] lg:px-[200px] relative justify-center items-center text-center gap-12'>
      ...
      <div className="relative flex flex-col items-center">
        <h1 className='text-[40px] sm:text-[45px] px-4 text-center lg:text-[60px] font-[700] w-fit mb-10'>Our <span className='text-[#43D0F7]'>Team</span></h1>
        <p className='text-[#e5e5e5] leading-[200%] text-[22px] font-light text-center'>Behind every successful campaign is a dedicated team of professionals.  Meet the talented individuals who make up the Chiraro team and discover the expertise and passion they bring to every project.
          <br />
        </p>
      </div>
