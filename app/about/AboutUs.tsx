...
export default function AboutUs() {
  return (
    <div className='w-[95%] sm:w-[85%] md::w-[calc(100%-200px)] pt-[150px] flex flex-col mb-10 lg:mb-0 relative'>
      ...
      <div className='flex justify-center items-center flex-col-reverse lg:flex-row gap-16 lg:gap-0'>
        <div className="w-full lg:w-1/2 flex justify-center lg:justify-start items-center lg:items-start flex-col gap-5 text-center lg:text-start">
