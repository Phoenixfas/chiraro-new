...
export default function GraphicsPricing() {
  return (
    <div className='w-full flex flex-col items-center mt-20 lg:mt-40 relative overflow-x-clip px-5'>
        ...
        <h1 className='text-4xl font-black mb-10 text-center'><span className='text-[#43D0F7]'>Graphics</span> Pricing</h1>
