    ...
    return (
        <div className="w-full overflow-hidden">
            <div className={`relative flex duration-300 ${wType === "static" ? "translate-x-0" : "-translate-x-full"}`}>
                <div className="min-w-full max-w-full flex items-center justify-center gap-14 [&>*:nth-child(even)]:py-28 [&>*:nth-child(even)]:bg-[#1E1E1E] [&>*:nth-child(even)]:border-[5px] [&>*:nth-child(even)]:border-[#43D0F7]">
