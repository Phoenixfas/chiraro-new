...
export default function Home() {
  ...
  return (
    <main className={`${"w-full h-full flex flex-col items-center relative"} ${poppins.className}`}>
      <div className="absolute top-0 left-[35%] w-[1px] h-full bg-[rgba(238,238,238,0.1)] -z-[1]" >
        ...
        <ScrollOffers/>
      <div className="absolute top-[150px] left-0 w-full h-[1px] bg-[rgba(238,238,238,0.1)] -z-[1]" ></div>
      <Hero />
      <Offers />
    </main>
  );
